        ...
        success: function(response) {
            ...
            if (jsonResp && jsonResp.User && jsonResp.User.length > 0) {
                ...
                if (userData) {
                    ...
                    txtAccountFullName.value = userData.Name;
...
// {"DATA":{"ROOT_CUST_PRTL_GETUSERINFO":{"ITEMS":[{"USR_EMAIL":"tsherman@eccentex.com","USR_PHONE":"1-949-235-9009","USR_NAME":"Tadeusz Sherman","USR_FIRSTNAME":"Tadeusz","USR_LASTNAME":"Sherman","USR_LASTLOGINDATE":1589230156000,"EP_ID":1,"PPL_EPAUPREPLYADDRESS":"rklusek1/domyslna","PPL_PESEL":"72121628861","PPL_EMAIL2":"ttnow@live.com"}],"VALIDATION":null,"IsValid":true}}}
...
//            console.log("DATA "+data);
            if (data) {
                ...
                console.log("Pesel= "+ respSuccess.PPL_PESEL);
